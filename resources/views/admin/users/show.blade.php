...
@section('content')
    ...
    <x-breadcrumb title="View Application"></x-breadcrumb>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h4 class="mt-0 header-title mb-3">View Application</h4>
                        <div>
                    ...
                    <div class="row" id="print_form">
                        ...
                        <div class="col-12 mb-3 pb-5 border-0">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="middle_name" name="middle_name" type="text"
                                                    class="form-control" value="{{ $personal_information->middle_name }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="social_security_number" name="social_security_number"
                                                    ...
                                                    value="{{ $personal_information->social_security_number }}" />
                                            </div>

                                            <div class="col-md-6 mb-3 form-group">
                                                <label for="home_address" class="form-label">Home Address</label>
                                                <input id="home_address" name="home_address" type="text"
                                                    class="form-control" value="{{ $personal_information->home_address }}"
                                                    required />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="state" name="state" type="text" class="form-control"
                                                    value="{{ $personal_information->state }}" required />
                                            </div>

                                            <div class="col-md-6 mb-3 form-group">
                                                <label for="zip_code" class="form-label">Zip code</label>
                                                <input id="zip_code" name="zip_code" type="text"
                                                    class="form-control" value="{{ $personal_information->zip_code }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="cell_phone_number" name="cell_phone_number" type="text"
                                                    class="form-control"
                                                    value="{{ $personal_information->cell_phone_number }}" required />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="office_phone_number" name="office_phone_number" type="text"
                                                    class="form-control"
                                                    value="{{ $personal_information->office_phone_number }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="office_state" name="office_state" type="text"
                                                    class="form-control"
                                                    value="{{ $personal_information->office_state }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="office_zip_code" name="office_zip_code" type="text"
                                                    class="form-control"
                                                    value="{{ $personal_information->office_zip_code }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="email_address" name="email_address" type="text"
                                                    class="form-control"
                                                    value="{{ $personal_information->email_address }}" required />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="birth_date" name="birth_date" type="date"
                                                    class="form-control"
                                                    value="{{ $personal_information->birth_date }}" />
                                            </div>

                                            <div class="col-md-6 mb-3 form-group">
                                                <label for="primary_speciality" class="form-label">Primary
                                                    Speciality</label>
                                                <input id="primary_speciality" name="primary_speciality" type="text"
                                                    class="form-control"
                                                    value="{{ $personal_information->primary_speciality }}" />
                                            </div>

                                            <div class="col-md-6 mb-3 form-group">
                                                <label for="secondary_speciality" class="form-label">Secondary
                                                    Speciality</label>
                                                <input id="secondary_speciality" name="secondary_speciality"
                                                    type="text" class="form-control"
                                                    value="{{ $personal_information->secondary_speciality }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="fed_tax_id" name="fed_tax_id" type="text"
                                                    class="form-control"
                                                    value="{{ $personal_information->fed_tax_id }}" />
                                            </div>

                                            <div class="col-md-6 mb-3 form-group">
                                                <label for="medicaid" class="form-label">Medicaid #</label>
                                                <input id="medicaid" name="medicaid" type="text"
                                                    class="form-control" value="{{ $personal_information->medicaid }}" />
                                            </div>
                            ...
                            <section id="step-2" class="education-and-training mb-5" role="tabpanel"
                                ...
                                <div class="card border border-dark rounded">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6 mb-3 form-group">
                                                <label for="medical_school" class="form-label font-weight-bold">Medical
                                                    School</label>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="start_date" name="start_date" type="date"
                                                    class="form-control"
                                                    value="{{ $education_and_training->start_date }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="e_city" name="e_city" type="text" class="form-control"
                                                    value="{{ $education_and_training->e_city }}" />
                                            </div>

                                            <div class="col-md-6 mb-3 form-group">
                                                <label for="e_state" class="form-label">State</label>
                                                <input id="e_state" name="e_state" type="text" class="form-control"
                                                    value="{{ $education_and_training->e_state }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="internship_training_name" name="internship_training_name"
                                                    type="text" class="form-control"
                                                    value="{{ $education_and_training->internship_training_name }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="internship_training_city" name="internship_training_city"
                                                    type="text" class="form-control"
                                                    value="{{ $education_and_training->internship_training_city }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="internship_training_state" name="internship_training_state"
                                                    type="text" class="form-control"
                                                    value="{{ $education_and_training->internship_training_state }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="category_of_training" name="category_of_training"
                                                    type="text" class="form-control"
                                                    value="{{ $education_and_training->category_of_training }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="residency_training_name" name="residency_training_name"
                                                    type="text" class="form-control"
                                                    value="{{ $education_and_training->residency_training_name }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="residency_training_city" name="residency_training_city"
                                                    type="text" class="form-control"
                                                    value="{{ $education_and_training->residency_training_city }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="residency_training_state" name="residency_training_state"
                                                    type="text" class="form-control"
                                                    value="{{ $education_and_training->residency_training_state }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                <label for="residency_training_end_date" class="form-label">End
                                                    Date</label>
                                                <input id="residency_training_end_date" name="residency_training_end_date"
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="residency_training_speciality"
                                                    ...
                                                    class="form-control"
                                                    value="{{ $education_and_training->residency_training_speciality }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="fellowship_training_name" name="fellowship_training_name"
                                                    type="text" class="form-control"
                                                    value="{{ $education_and_training->fellowship_training_name }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="fellowship_training_city" name="fellowship_training_city"
                                                    type="text" class="form-control"
                                                    value="{{ $education_and_training->fellowship_training_city }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="fellowship_training_state" name="fellowship_training_state"
                                                    type="text" class="form-control"
                                                    value="{{ $education_and_training->fellowship_training_state }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="fellowship_training_speciality"
                                                    ...
                                                    class="form-control"
                                                    value="{{ $education_and_training->fellowship_training_speciality }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="additional_training_name" name="additional_training_name"
                                                    type="text" class="form-control"
                                                    value="{{ $education_and_training->additional_training_name }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="additional_training_city" name="additional_training_city"
                                                    type="text" class="form-control"
                                                    value="{{ $education_and_training->additional_training_city }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="additional_training_state" name="additional_training_state"
                                                    type="text" class="form-control"
                                                    value="{{ $education_and_training->additional_training_state }}" />
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mb-3 form-group">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="board_certified"
                                                        ...
                                                        {{ $board_certifications[0]->board_certified == 'yes' ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="board_certified_yes">Yes</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="board_certified"
                                                        id="board_certified_no" value="no"
                                                        {{ $board_certifications[0]->board_certified == 'no' ? 'checked' : '' }}>
                                                ...
                                                @foreach ($board_certifications as $key => $board_certificate)
                                                    <div class="row certificate_wrapper_item">
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input name="issuing_board[{{ $key }}]"
                                                                type="text" class="form-control"
                                                                value="{{ $board_certificate->issuing_board }}" />
                                                        </div>
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input name="issuing_board_speciality[{{ $key }}]"
                                                                type="text" class="form-control"
                                                                value="{{ $board_certificate->issuing_board_speciality }}" />
                                                        </div>
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input
                                                                name="issuing_board_certified_date[{{ $key }}]"
                                                                type="date" class="form-control"
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input
                                                                name="issuing_board_recertified_date[{{ $key }}]"
                                                                type="date" class="form-control"
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input
                                                                name="issuing_board_expiration_date[{{ $key }}]"
                                                                type="date" class="form-control"
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="examined_board_name" name="examined_board_name" type="text"
                                                    class="form-control"
                                                    value="{{ $board_certificate->examined_board_name }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="examined_board_date" name="examined_board_date" type="date"
                                                    class="form-control"
                                                    value="{{ $board_certificate->examined_board_date }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="certified_board_date" name="certified_board_date"
                                                    type="date" class="form-control"
                                                    value="{{ $board_certificate->certified_board_date }}" />
                                            </div>
                                                ...
                                                <div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            value="yes"
                                                            {{ $board_certificate->bls_certification == 'yes' ? 'checked' : '' }}>
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            value="no"
                                                            {{ $board_certificate->bls_certification == 'no' ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="bls_certification_expiration_date"
                                                    ...
                                                    class="form-control"
                                                    value="{{ $board_certificate->bls_certification_expiration_date }}" />
                                            </div>
                                                ...
                                                <div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            value="yes"
                                                            {{ $board_certificate->acls_certification == 'yes' ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            value="no"
                                                            {{ $board_certificate->acls_certification == 'no' ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="acls_certification_expiration_date"
                                                    ...
                                                    class="form-control"
                                                    value="{{ $board_certificate->acls_certification_expiration_date }}" />
                                            </div>
                                                ...
                                                <div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            value="yes"
                                                            {{ $board_certificate->atls_certification == 'yes' ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            value="no"
                                                            {{ $board_certificate->atls_certification == 'no' ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="atls_certification_expiration_date"
                                                    ...
                                                    class="form-control"
                                                    value="{{ $board_certificate->atls_certification_expiration_date }}" />
                                            </div>
                                                ...
                                                <div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            value="yes"
                                                            {{ $board_certificate->pals_certification == 'yes' ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            value="no"
                                                            {{ $board_certificate->pals_certification == 'no' ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="pals_certification_expiration_date"
                                                    ...
                                                    class="form-control"
                                                    value="{{ $board_certificate->pals_certification_expiration_date }}" />
                                            </div>
                                                ...
                                                <div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            value="yes"
                                                            {{ $board_certificate->ecfmg_certificate == 'yes' ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            value="no"
                                                            {{ $board_certificate->ecfmg_certificate == 'no' ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="ecfmg_certificate_id" name="ecfmg_certificate_id"
                                                    type="text" class="form-control"
                                                    value="{{ $board_certificate->ecfmg_certificate_id }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            name="fifth_pathway" id="fifth_pathway_yes" value="yes"
                                                            {{ $board_certificate->fifth_pathway == 'yes' ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            {{ $board_certificate->fifth_pathway == 'no' ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="fifth_pathway_location" name="fifth_pathway_location"
                                                    type="text" class="form-control"
                                                    value="{{ $board_certificate->fifth_pathway_location }}" />
                                            </div>
                                                ...
                                                <div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            value="yes"
                                                            {{ $board_certificate->national_board_exam == 'yes' ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            value="no"
                                                            {{ $board_certificate->national_board_exam == 'no' ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="national_board_exam_date" name="national_board_exam_date"
                                                    type="date" class="form-control"
                                                    value="{{ $board_certificate->national_board_exam_date }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="flex_exam"
                                                            id="flex_exam_yes" value="yes"
                                                            {{ $board_certificate->flex_exam == 'yes' ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="flex_exam_yes">Yes</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="flex_exam"
                                                            id="flex_exam_no" value="no"
                                                            {{ $board_certificate->flex_exam == 'no' ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="flex_exam_date" name="flex_exam_date" type="date"
                                                    class="form-control"
                                                    value="{{ $board_certificate->flex_exam_date }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="spex_exam"
                                                            id="spex_exam_yes" value="yes"
                                                            {{ $board_certificate->spex_exam == 'yes' ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="spex_exam_yes">Yes</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="spex_exam"
                                                            id="spex_exam_no" value="no"
                                                            {{ $board_certificate->spex_exam == 'no' ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="spex_exam_date" name="spex_exam_date" type="date"
                                                    class="form-control"
                                                    value="{{ $board_certificate->spex_exam_date }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="usmle_exam"
                                                            id="usmle_exam_yes" value="yes"
                                                            {{ $board_certificate->usmle_exam == 'yes' ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="usmle_exam_yes">Yes</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="usmle_exam"
                                                            id="usmle_exam_no" value="no"
                                                            {{ $board_certificate->usmle_exam == 'no' ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="usmle_exam_date" name="usmle_exam_date" type="date"
                                                    class="form-control"
                                                    value="{{ $board_certificate->usmle_exam_date }}" />
                                            </div>
                                                ...
                                                <div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            value="yes"
                                                            {{ $board_certificate->state_board_exam == 'yes' ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            value="no"
                                                            {{ $board_certificate->state_board_exam == 'no' ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="state_board_exam_date" name="state_board_exam_date"
                                                    type="date" class="form-control"
                                                    value="{{ $board_certificate->state_board_exam_date }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="lmcc_exam"
                                                            id="lmcc_exam_yes" value="yes"
                                                            {{ $board_certificate->lmcc_exam == 'yes' ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="lmcc_exam_yes">Yes</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="lmcc_exam"
                                                            id="lmcc_exam_no" value="no"
                                                            {{ $board_certificate->lmcc_exam == 'no' ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="lmcc_exam_date" name="lmcc_exam_date" type="date"
                                                    class="form-control"
                                                    value="{{ $board_certificate->lmcc_exam_date }}" />
                                            </div>
                            ...
                            <section id="step-4" class="licensing mb-5" role="tabpanel" aria-labelledby="step-4">
                                <div class="card border border-dark rounded">
                                    <div class="card-header bg-gray-200 border-bottom border-dark font-weight-bold">
                                        STATE LICENSING
                                    </div>
                                                ...
                                                @foreach ($licensing as $key => $license)
                                                    <div class="row licensing_wrapper_item">
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <select name="licensing_state[{{ $key }}]"
                                                                class="form-control">
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <select name="license_status[{{ $key }}]"
                                                                class="form-control">
                                                                <option value="active"
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input name="license_granted_date[{{ $key }}]"
                                                                type="date" class="form-control"
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input name="license_expiration_date[{{ $key }}]"
                                                                type="date" class="form-control"
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input
                                                                name="state_medicare_provider_number[{{ $key }}]"
                                                                type="text" class="form-control"
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input
                                                                name="state_medicaid_provider_number[{{ $key }}]"
                                                                type="text" class="form-control"
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group d-none">
                                                            ...
                                                            <input
                                                                name="state_controlled_substance_permit_number[{{ $key }}]"
                                                                type="text" class="form-control"
                                                ...
                                                @foreach ($dea_substances as $key => $dea_substance)
                                                    <div class="row licensing_dea_wrapper_item">
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input name="federal_dea_number"
                                                                type="text" class="form-control"
                                                                value="{{ $dea_substance->federal_dea_number }}" />
                                                        </div>
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input name="dea_expiration_date"
                                                                type="date" class="form-control"
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            <label class="form-label">State</label>
                                                            <select name="licensing_dea_state[{{ $key }}]"
                                                                class="form-control">
                                                                <option
                                                                    value="{{ $dea_substance->licensing_dea_state }}">
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input name="license_dea_number[{{ $key }}]"
                                                                type="text" class="form-control"
                                                                value="{{ $dea_substance->license_dea_number }}" />
                                                        </div>
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <select name="license_dea_status[{{ $key }}]"
                                                                class="form-control">
                                                                <option value="active"
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input name="license_dea_granted_date[{{ $key }}]"
                                                                type="date" class="form-control"
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input
                                                                name="license_dea_expiration_date[{{ $key }}]"
                                                                type="date" class="form-control"
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input
                                                                name="dea_state_medicare_provider_number[{{ $key }}]"
                                                                type="text" class="form-control"
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input
                                                                name="dea_state_medicaid_provider_number[{{ $key }}]"
                                                                type="text" class="form-control"
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input
                                                                name="dea_state_controlled_substance_permit_number[{{ $key }}]"
                                                                type="text" class="form-control"
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="reference_1_name" name="reference_1_name" type="text"
                                                    class="form-control"
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="reference_1_specialty" name="reference_1_specialty"
                                                    type="text" class="form-control"
                                                    value="{{ $references[0]->reference_1_specialty }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="reference_1_phone_no" name="reference_1_phone_no"
                                                    type="text" class="form-control"
                                                    value="{{ $references[0]->reference_1_phone_no }}" required />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="reference_1_position" name="reference_1_position"
                                                    type="text" class="form-control"
                                                    value="{{ $references[0]->reference_1_position }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="reference_1_address" name="reference_1_address"
                                                    type="text" class="form-control"
                                                    value="{{ $references[0]->reference_1_address }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="reference_1_city" name="reference_1_city" type="text"
                                                    class="form-control"
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="reference_1_state" name="reference_1_state" type="text"
                                                    class="form-control"
                                                    value="{{ $references[0]->reference_1_state }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group d-none">
                                                ...
                                                <input id="reference_1_zipcode" name="reference_1_zipcode"
                                                    type="text" class="form-control"
                                                    value="{{ $references[0]->reference_1_zipcode }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="reference_1_email" name="reference_1_email" type="text"
                                                    class="form-control"
                                                    value="{{ $references[0]->reference_1_email }}" required />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="reference_1_facility" name="reference_1_facility"
                                                    type="text" class="form-control"
                                                    value="{{ $references[0]->reference_1_facility }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="reference_2_name" name="reference_2_name" type="text"
                                                    class="form-control"
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="reference_2_specialty" name="reference_2_specialty"
                                                    type="text" class="form-control"
                                                    value="{{ $references[0]->reference_2_specialty }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="reference_2_position" name="reference_2_position"
                                                    type="text" class="form-control"
                                                    value="{{ $references[0]->reference_2_position }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="reference_2_address" name="reference_2_address"
                                                    type="text" class="form-control"
                                                    value="{{ $references[0]->reference_2_address }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="reference_2_city" name="reference_2_city" type="text"
                                                    class="form-control"
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="reference_2_state" name="reference_2_state" type="text"
                                                    class="form-control"
                                                    value="{{ $references[0]->reference_2_state }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group d-none">
                                                ...
                                                <input id="reference_2_zipcode" name="reference_2_zipcode"
                                                    type="text" class="form-control"
                                                    value="{{ $references[0]->reference_2_zipcode }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="reference_2_email" name="reference_2_email" type="text"
                                                    class="form-control"
                                                    value="{{ $references[0]->reference_2_email }}" required />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="reference_2_facility" name="reference_2_facility"
                                                    type="text" class="form-control"
                                                    value="{{ $references[0]->reference_2_facility }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="reference_3_name" name="reference_3_name" type="text"
                                                    class="form-control"
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="reference_3_specialty" name="reference_3_specialty"
                                                    type="text" class="form-control"
                                                    value="{{ $references[0]->reference_3_specialty }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="reference_3_phone_no" name="reference_3_phone_no"
                                                    type="text" class="form-control"
                                                    value="{{ $references[0]->reference_3_phone_no }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="reference_3_position" name="reference_3_position"
                                                    type="text" class="form-control"
                                                    value="{{ $references[0]->reference_3_position }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="reference_3_address" name="reference_3_address"
                                                    type="text" class="form-control"
                                                    value="{{ $references[0]->reference_3_address }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="reference_3_city" name="reference_3_city" type="text"
                                                    class="form-control"
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="reference_3_state" name="reference_3_state" type="text"
                                                    class="form-control"
                                                    value="{{ $references[0]->reference_3_state }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group d-none">
                                                ...
                                                <input id="reference_3_zipcode" name="reference_3_zipcode"
                                                    type="text" class="form-control"
                                                    value="{{ $references[0]->reference_3_zipcode }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="reference_3_email" name="reference_3_email" type="text"
                                                    class="form-control"
                                                    value="{{ $references[0]->reference_3_email }}" required />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="reference_3_facility" name="reference_3_facility"
                                                    type="text" class="form-control"
                                                    value="{{ $references[0]->reference_3_facility }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="reference_4_name" name="reference_4_name" type="text"
                                                    class="form-control"
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="reference_4_specialty" name="reference_4_specialty"
                                                    type="text" class="form-control"
                                                    value="{{ $references[0]->reference_4_specialty }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="reference_4_position" name="reference_4_position"
                                                    type="text" class="form-control"
                                                    value="{{ $references[0]->reference_4_position }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="reference_4_address" name="reference_4_address"
                                                    type="text" class="form-control"
                                                    value="{{ $references[0]->reference_4_address }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="reference_4_city" name="reference_4_city" type="text"
                                                    class="form-control"
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="reference_4_state" name="reference_4_state" type="text"
                                                    class="form-control"
                                                    value="{{ $references[0]->reference_4_state }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group d-none">
                                                ...
                                                <input id="reference_4_zipcode" name="reference_4_zipcode"
                                                    type="text" class="form-control"
                                                    value="{{ $references[0]->reference_4_zipcode }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="reference_4_email" name="reference_4_email" type="text"
                                                    class="form-control"
                                                    value="{{ $references[0]->reference_4_email }}" required />
                                            </div>
                                                ...
                                                @foreach ($work_history as $key => $wh)
                                                    <div class="row work_history_wrapper_item">
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input name="work_history_from[{{ $key }}]"
                                                                type="date" class="form-control"
                                                                value="{{ $wh->work_history_from }}" />
                                                        </div>
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input name="work_history_to[{{ $key }}]"
                                                                type="date" class="form-control"
                                                                value="{{ $wh->work_history_to }}" />
                                                        </div>
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input
                                                                name="work_history_facility_name[{{ $key }}]"
                                                                type="text" class="form-control"
                                                                value="{{ $wh->work_history_facility_name }}" />
                                                        </div>
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group d-none">
                                                            ...
                                                            <input name="work_history_phone[{{ $key }}]"
                                                                type="text" class="form-control"
                                                                value="{{ $wh->work_history_phone }}" />
                                                        </div>
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input name="work_history_address[{{ $key }}]"
                                                                type="text" class="form-control"
                                                                value="{{ $wh->work_history_address }}" />
                                                        </div>
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input name="work_history_city[{{ $key }}]"
                                                                type="text" class="form-control"
                                                                value="{{ $wh->work_history_city }}" />
                                                        </div>
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input name="work_history_state[{{ $key }}]"
                                                                type="text" class="form-control"
                                                                value="{{ $wh->work_history_state }}" />
                                                        </div>
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group d-none">
                                                            ...
                                                            <input name="work_history_zipcode[{{ $key }}]"
                                                                type="text" class="form-control"
                                                                value="{{ $wh->work_history_zipcode }}" />
                                                        </div>
                                            ...
                                            <div class="col-md-12 d-flex gap-5 mb-3">
                                                ...
                                                <div class="form-check ml-3">
                                                    <input class="form-check-input"
                                                        ...
                                                        {{ $hospital_and_affiliations[0]->hospital_and_affiliation_apply == '1' ? 'checked' : '' }}>
                                                    <label class="form-check-label"
                                                ...
                                                @foreach ($hospital_and_affiliations as $key => $hospital_and_affiliation)
                                                    <div class="row hospital_affiliation_wrapper_item">
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input name="primary_facility_name[{{ $key }}]"
                                                                type="text" class="form-control"
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input name="appointment_from[{{ $key }}]"
                                                                type="date" class="form-control"
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input name="appointment_to[{{ $key }}]"
                                                                type="date" class="form-control"
                                                                value="{{ $hospital_and_affiliation->appointment_to }}" />
                                                        </div>
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input name="appointment_city[{{ $key }}]"
                                                                type="text" class="form-control"
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input name="appointment_state[{{ $key }}]"
                                                                type="text" class="form-control"
                                                                value="{{ $hospital_and_affiliation->appointment_state }}" />
                                                        </div>
                            ...
                            <section id="step-8" class="disclusres-and-disciplinary-actions mb-5" role="tabpanel"
                                                ...
                                                <div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            {{ $disclusres_and_disciplinary_action->question_1 == 'yes' ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="question_1_yes">Yes</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            name="question_1" id="question_1_no" value="no"
                                                            {{ $disclusres_and_disciplinary_action->question_1 == 'no' ? 'checked' : '' }}>
                                                ...
                                                <div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            {{ $disclusres_and_disciplinary_action->question_2 == 'yes' ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="question_2_yes">Yes</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            name="question_2" id="question_2_no" value="no"
                                                            {{ $disclusres_and_disciplinary_action->question_2 == 'no' ? 'checked' : '' }}>
                                                ...
                                                <div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            {{ $disclusres_and_disciplinary_action->question_3 == 'yes' ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="question_3_yes">Yes</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            name="question_3" id="question_3_no" value="no"
                                                            {{ $disclusres_and_disciplinary_action->question_3 == 'no' ? 'checked' : '' }}>
                                                ...
                                                <div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            {{ $disclusres_and_disciplinary_action->question_4 == 'yes' ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="question_4_yes">Yes</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            name="question_4" id="question_4_no" value="no"
                                                            {{ $disclusres_and_disciplinary_action->question_4 == 'no' ? 'checked' : '' }}>
                                                ...
                                                <div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            {{ $disclusres_and_disciplinary_action->question_5 == 'yes' ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="question_5_yes">Yes</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            name="question_5" id="question_5_no" value="no"
                                                            {{ $disclusres_and_disciplinary_action->question_5 == 'no' ? 'checked' : '' }}>
                                                ...
                                                <div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            {{ $disclusres_and_disciplinary_action->question_6 == 'yes' ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="question_6_yes">Yes</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            name="question_6" id="question_6_no" value="no"
                                                            {{ $disclusres_and_disciplinary_action->question_6 == 'no' ? 'checked' : '' }}>
                                                ...
                                                <div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            {{ $disclusres_and_disciplinary_action->question_7 == 'yes' ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="question_7_yes">Yes</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            name="question_7" id="question_7_no" value="no"
                                                            {{ $disclusres_and_disciplinary_action->question_7 == 'no' ? 'checked' : '' }}>
                                                ...
                                                <div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            {{ $disclusres_and_disciplinary_action->question_8 == 'yes' ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="question_8_yes">Yes</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            name="question_8" id="question_8_no" value="no"
                                                            {{ $disclusres_and_disciplinary_action->question_8 == 'no' ? 'checked' : '' }}>
                                                ...
                                                <div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            {{ $disclusres_and_disciplinary_action->question_9 == 'yes' ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="question_9_yes">Yes</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            name="question_9" id="question_9_no" value="no"
                                                            {{ $disclusres_and_disciplinary_action->question_9 == 'no' ? 'checked' : '' }}>
                                                ...
                                                <div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            {{ $disclusres_and_disciplinary_action->question_10 == 'yes' ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            {{ $disclusres_and_disciplinary_action->question_10 == 'no' ? 'checked' : '' }}>
                                                ...
                                                <div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            {{ $disclusres_and_disciplinary_action->question_11 == 'yes' ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            {{ $disclusres_and_disciplinary_action->question_11 == 'no' ? 'checked' : '' }}>
                                                ...
                                                <div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            {{ $disclusres_and_disciplinary_action->question_12 == 'yes' ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            {{ $disclusres_and_disciplinary_action->question_12 == 'no' ? 'checked' : '' }}>
                                                ...
                                                <div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            {{ $disclusres_and_disciplinary_action->question_13 == 'yes' ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            {{ $disclusres_and_disciplinary_action->question_13 == 'no' ? 'checked' : '' }}>
                                                ...
                                                <div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            {{ $disclusres_and_disciplinary_action->question_14 == 'yes' ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            {{ $disclusres_and_disciplinary_action->question_14 == 'no' ? 'checked' : '' }}>
                                                ...
                                                <div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            {{ $disclusres_and_disciplinary_action->question_15 == 'yes' ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            {{ $disclusres_and_disciplinary_action->question_15 == 'no' ? 'checked' : '' }}>
                                                ...
                                                <div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            {{ $disclusres_and_disciplinary_action->question_16 == 'yes' ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            {{ $disclusres_and_disciplinary_action->question_16 == 'no' ? 'checked' : '' }}>
                                                ...
                                                <div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            {{ $disclusres_and_disciplinary_action->question_17 == 'yes' ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            {{ $disclusres_and_disciplinary_action->question_17 == 'no' ? 'checked' : '' }}>
                                                ...
                                                <div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            {{ $disclusres_and_disciplinary_action->question_18 == 'yes' ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            {{ $disclusres_and_disciplinary_action->question_18 == 'no' ? 'checked' : '' }}>
                                                ...
                                                <div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            {{ $disclusres_and_disciplinary_action->question_19 == 'yes' ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            {{ $disclusres_and_disciplinary_action->question_19 == 'no' ? 'checked' : '' }}>
                                                ...
                                                @foreach ($credentialing_application_form as $key => $caf)
                                                    <div class="row explanation_wrapper_item">
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input name="explanation_question[{{ $key }}]"
                                                                type="date" class="form-control"
                                                                value="{{ $caf->explanation_date }}" />
                                                        </div>
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <textarea name="explanation_answer[{{ $key }}]"
                                                                class="form-control">{{ $caf->explanation_answer }}</textarea>
                                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            name="malpractice_question_1" id="malpractice_question_1_no"
                                                            value="no"
                                            ...
                                            <input type="hidden" name="attachment_file"
                                                value="{{ $malpractice_information->attachment }}">
                                            ...
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            name="malpractice_question_2" id="malpractice_question_2_no"
                                                            value="no"
                                            ...
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            name="malpractice_question_3" id="malpractice_question_3_no"
                                                            value="no"
                                                ...
                                                @foreach ($malpractice_claims as $key => $malpractice_claim)
                                                    <div class="row insurance_claim_wrapper_item">
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input name="plantiff_name[{{ $key }}]"
                                                                type="text" class="form-control"
                                                                value="{{ $malpractice_claim->plantiff_name }}" />
                                                        </div>
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input name="location[{{ $key }}]" type="text"
                                                                class="form-control"
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input name="status[{{ $key }}]" type="text"
                                                                class="form-control"
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input name="date_of_incident[{{ $key }}]"
                                                                type="date" class="form-control"
                                            ...
                                            <div class="col-md-12 mt-5 mb-3 form-group">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="additional_malpractice_claim"
                                                        type="checkbox" value="1"
                                                ...
                                                @foreach ($malpractice_claim_policies as $key => $malpractice_claim_policy)
                                                    <div class="row additional_insurance_claim_wrapper_item">
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input
                                                                name="malpractice_insurance_carrier[{{ $key }}]"
                                                                type="text" class="form-control"
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input name="policy_date_from[{{ $key }}]"
                                                                type="date" class="form-control"
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input name="amount_of_coverage[{{ $key }}]"
                                                                type="text" class="form-control"
                            ...
                            <section id="step-11" class="current-continuing-medical-education mb-5" role="tabpanel"
                                                ...
                                                @foreach ($current_medical_education as $key => $cme)
                                                    <div class="row current_medical_education_wrapper_item">
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input name="program_date[{{ $key }}]"
                                                                type="date" class="form-control"
                                                                value="{{ $cme->program_date }}" />
                                                        </div>
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input name="sponsoring_organization[{{ $key }}]"
                                                                type="text" class="form-control"
                                                                value="{{ $cme->sponsoring_organization }}" />
                                                        </div>
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input name="certificate_of_cme[{{ $key }}]"
                                                                type="text" class="form-control"
                                                                value="{{ $cme->certificate_of_cme }}" />
                                                        </div>
                            ...
                            <section id="step-12" class="professional-liability-claims-information-form mb-5"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mb-3 form-group">
                                                ...
                                                <input name="reference_to_adverse_events" type="text"
                                                    class="form-control"
                                                    value="{{ $professional_liability_claim->reference_to_adverse_events }}" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input name="pending_status_date" type="date" class="form-control"
                                            ...
                                            <div class="col-md-5 mb-3 form-group">
                                                ...
                                                <input name="awaiting_trial_date" type="date" class="form-control"
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                <label class="form-label">Date</label>
                                                <input name="defense_verdict_date" type="date" class="form-control"
                            ...
                            {{-- <section id="step-13" class="additional-hospital-affiliations mb-5 d-none"
                                                    ...
                                                    @foreach ($additional_hospital_affiliations as $key => $aha)
                                                        <div class="row additional_hospital_affiliations_item">
                                                            ...
                                                            <div class="col-md-6 mb-3 form-group">
                                                                ...
                                                                <input name="ha_city_state_zip[{{ $key }}]"
                                                                    type="text" class="form-control"
                                                                    value="{{ $aha->ha_city_state_zip }}" />
                                                            </div>
                                                            ...
                                                            <div class="col-md-6 mb-3 form-group">
                                                                ...
                                                                <input name="ha_date_from[{{ $key }}]"
                                                                    type="date" class="form-control"
                                                                    value="{{ $aha->ha_date_from }}" />
                                                            </div>
                                                            ...
                                                            <div class="col-md-6 mb-3 form-group">
                                                                ...
                                                                <input name="ha_date_to[{{ $key }}]"
                                                                    type="date" class="form-control"
                                                                    value="{{ $aha->ha_date_to }}" />
                                                            </div>
    ...
    <script>
        function print() {
            printJS({
                ...
                targetStyles: ['*'],
                css: '{{ asset('assets/admin/css/bootstrap.min.css') }}',
                scanStyles: true,
            })
        }
    </script>

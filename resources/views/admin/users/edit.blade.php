...
@section('content')
    ...
    <x-breadcrumb title="Edit Application"></x-breadcrumb>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3 form-group">
                                                    ...
                                                    <input id="state" name="state" type="text"
                                                        class="form-control" value="{{ $personal_information->state }}"
                                                        required />
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-3 form-group">
                                                    ...
                                                    <input id="zip_code" name="zip_code" type="text"
                                                        class="form-control"
                                                        value="{{ $personal_information->zip_code }}" />
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-3 form-group">
                                                    ...
                                                    <input id="npi" name="npi" type="text"
                                                        class="form-control" value="{{ $personal_information->npi }}"
                                                        required />
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-3 form-group">
                                                    ...
                                                    <input id="medicare" name="medicare" type="text"
                                                        class="form-control"
                                                        value="{{ $personal_information->medicare }}" />
                                                </div>

                                                <div class="col-md-6 mb-3 form-group">
                                                    <label for="upin" class="form-label">UPIN #</label>
                                                    <input id="upin" name="upin" type="text"
                                                        class="form-control" value="{{ $personal_information->upin }}" />
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-3 form-group">
                                                    ...
                                                    <input id="medicaid" name="medicaid" type="text"
                                                        class="form-control"
                                                        value="{{ $personal_information->medicaid }}" />
                                                </div>
                                                    ...
                                                    @foreach ($board_certifications as $key => $board_certificate)
                                                        <div class="row certificate_wrapper_item">
                                                            ...
                                                            <div class="col-md-6 mb-3 form-group">
                                                                ...
                                                                <input
                                                                    name="issuing_board_speciality[{{ $key }}]"
                                                                    type="text" class="form-control"
                                                    ...
                                                    @foreach ($licensing as $key => $license)
                                                        <div class="row licensing_wrapper_item">
                                                            ...
                                                            <div class="col-md-6 mb-3 form-group">
                                                                ...
                                                                <input
                                                                    name="license_expiration_date[{{ $key }}]"
                                                                    type="date" class="form-control"
                                                    ...
                                                    @foreach ($dea_substances as $key => $dea_substance)
                                                        <div class="row licensing_dea_wrapper_item">
                                                            ...
                                                            <div class="col-md-6 mb-3 form-group">
                                                                ...
                                                                <input name="federal_dea_number[{{ $key }}]"
                                                                    type="text" class="form-control"
                                                            ...
                                                            <div class="col-md-6 mb-3 form-group">
                                                                ...
                                                                <input name="dea_expiration_date[{{ $key }}]"
                                                                    type="date" class="form-control"
                                                            ...
                                                            <div class="col-md-6 mb-3 form-group">
                                                                ...
                                                                <input
                                                                    name="license_dea_granted_date[{{ $key }}]"
                                                                    type="date" class="form-control"
                                                    ...
                                                    @foreach ($credentialing_application_form as $key => $caf)
                                                        <div class="row explanation_wrapper_item">
                                                            ...
                                                            <div class="col-md-6 mb-3 form-group">
                                                                ...
                                                                <input name="explanation_date[{{ $key }}]"
                                                                    type="date" class="form-control"
                                                    ...
                                                    @foreach ($malpractice_claims as $key => $malpractice_claim)
                                                        <div class="row insurance_claim_wrapper_item">
                                                            ...
                                                            <div class="col-md-6 mb-3 form-group">
                                                                ...
                                                                <input name="amount_of_award[{{ $key }}]"
                                                                    type="text" class="form-control"
                                                                    value="{{ $malpractice_claim->amount_of_award }}" />
                                                            </div>
                                                    ...
                                                    @foreach ($current_medical_education as $key => $cme)
                                                        <div class="row current_medical_education_wrapper_item">
                                                            ...
                                                            <div class="col-md-6 mb-3 form-group">
                                                                ...
                                                                <input
                                                                    name="sponsoring_organization[{{ $key }}]"
                                                                    type="text" class="form-control"

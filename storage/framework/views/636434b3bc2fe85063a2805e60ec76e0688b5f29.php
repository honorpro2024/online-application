...
<?php foreach($attributes->onlyProps(['references' => null]) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
<?php $attributes = $attributes->exceptProps(['references' => null]); ?>
<?php foreach (array_filter((['references' => null]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<?php if($references == null || empty($references)): ?>
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3 form-group">
                        ...
                        <select class="form-select" id="reference_1_specialty" name="reference_1_specialty">
                            <?php if($references[0]->reference_1_specialty == ''): ?>
                                <option value="">Select Your Specialty</option>
                            <?php else: ?>
                                <option value="<?php echo e($references[0]->reference_1_specialty); ?>">
                                    <?php echo e($references[0]->reference_1_specialty); ?>
...
<?php endif; ?>
                    ...
                    <div class="col-md-6 mb-3 form-group">
                        ...
                        <input id="reference_1_phone_no" name="reference_1_phone_no" type="text"
                            class="form-control unique_phone_no" value="<?php echo e($references[0]->reference_1_phone_no ?? ''); ?>"
                            oninput="validateNumber(this)" maxlength="10" required />
                    </div>
                    ...
                    <div class="col-md-6 mb-3 form-group">
                        ...
                        <input id="reference_1_position" name="reference_1_position" type="text"
                            class="form-control" value="<?php echo e($references[0]->reference_1_position ?? ''); ?>" />
                    </div>
                    ...
                    <div class="col-md-6 mb-3 form-group">
                        ...
                        <input id="reference_1_address" name="reference_1_address" type="text"
                            class="form-control" value="<?php echo e($references[0]->reference_1_address ?? ''); ?>" />
                    </div>
                    ...
                    <div class="col-md-6 mb-3 form-group">
                        ...
                        <select name="reference_1_state" class="form-select">
                            <option value="<?php echo e($references[0]->reference_1_state ?? ''); ?>">
                                <?php echo e($references[0]->reference_1_state ?? ''); ?>
...
<?php endif; ?>
                    ...
                    <div class="col-md-6 mb-3 form-group d-none">
                        ...
                        <input id="reference_1_zipcode" name="reference_1_zipcode" type="text"
                            class="form-control" value="<?php echo e($references[0]->reference_1_zipcode ?? ''); ?>"
                            data-rule-zipcodeUS="true" data-msg-zipcodeUS="Invalid Zip Code" />
                    </div>
                    ...
                    <div class="col-md-6 mb-3 form-group">
                        ...
                        <input id="reference_1_email" name="reference_1_email" type="text" class="form-control unique_email"
                            value="<?php echo e($references[0]->reference_1_email ?? ''); ?>" data-rule-email="true" required />
                    </div>
                    ...
                    <div class="col-md-6 mb-3 form-group">
                        ...
                        <input id="reference_1_facility" name="reference_1_facility" type="text"
                            class="form-control" value="<?php echo e($references[0]->reference_1_facility ?? ''); ?>" />
                    </div>
                    ...
                    <div class="col-md-6 mb-3 form-group">
                        ...
                        <select class="form-select" id="reference_2_specialty" name="reference_2_specialty">
                            <?php if($references[0]->reference_2_specialty == ''): ?>
                                <option value="">Select Your Specialty</option>
                            <?php else: ?>
                                <option value="<?php echo e($references[0]->reference_2_specialty); ?>">
                                    <?php echo e($references[0]->reference_2_specialty); ?>
...
<?php endif; ?>
                    ...
                    <div class="col-md-6 mb-3 form-group">
                        ...
                        <input id="reference_2_position" name="reference_2_position" type="text"
                            class="form-control" value="<?php echo e($references[0]->reference_2_position ?? ''); ?>" />
                    </div>
                    ...
                    <div class="col-md-6 mb-3 form-group">
                        ...
                        <input id="reference_2_address" name="reference_2_address" type="text"
                            class="form-control" value="<?php echo e($references[0]->reference_2_address ?? ''); ?>" />
                    </div>
                    ...
                    <div class="col-md-6 mb-3 form-group">
                        ...
                        <select name="reference_2_state" class="form-select">
                            <option value="<?php echo e($references[0]->reference_2_state ?? ''); ?>">
                                <?php echo e($references[0]->reference_2_state ?? ''); ?>
...
<?php endif; ?>
                    ...
                    <div class="col-md-6 mb-3 form-group d-none">
                        ...
                        <input id="reference_2_zipcode" name="reference_2_zipcode" type="text"
                            class="form-control" value="<?php echo e($references[0]->reference_2_zipcode ?? ''); ?>"
                            data-rule-zipcodeUS="true" data-msg-zipcodeUS="Invalid Zip Code" />
                    </div>
                    ...
                    <div class="col-md-6 mb-3 form-group">
                        ...
                        <input id="reference_2_email" name="reference_2_email" type="text" class="form-control unique_email"
                            value="<?php echo e($references[0]->reference_2_email ?? ''); ?>" data-rule-email="true" required />
                    </div>
                    ...
                    <div class="col-md-6 mb-3 form-group">
                        ...
                        <input id="reference_2_facility" name="reference_2_facility" type="text"
                            class="form-control" value="<?php echo e($references[0]->reference_2_facility ?? ''); ?>" />
                    </div>
                    ...
                    <div class="col-md-6 mb-3 form-group">
                        ...
                        <select class="form-select" id="reference_3_specialty" name="reference_3_specialty">
                            <?php if($references[0]->reference_3_specialty == ''): ?>
                                <option value="">Select Your Specialty</option>
                            <?php else: ?>
                                <option value="<?php echo e($references[0]->reference_3_specialty); ?>">
                                    <?php echo e($references[0]->reference_3_specialty); ?>
...
<?php endif; ?>
                    ...
                    <div class="col-md-6 mb-3 form-group">
                        ...
                        <input id="reference_3_phone_no" name="reference_3_phone_no" type="text"
                            class="form-control unique_phone_no" oninput="validateNumber(this)" maxlength="10"
                            value="<?php echo e($references[0]->reference_3_phone_no ?? ''); ?>" required />
                    </div>
                    ...
                    <div class="col-md-6 mb-3 form-group">
                        ...
                        <input id="reference_3_position" name="reference_3_position" type="text"
                            class="form-control" value="<?php echo e($references[0]->reference_3_position ?? ''); ?>" />
                    </div>
                    ...
                    <div class="col-md-6 mb-3 form-group">
                        ...
                        <input id="reference_3_address" name="reference_3_address" type="text"
                            class="form-control" value="<?php echo e($references[0]->reference_3_address ?? ''); ?>" />
                    </div>
                    ...
                    <div class="col-md-6 mb-3 form-group">
                        ...
                        <select name="reference_3_state" class="form-select">
                            <option value="<?php echo e($references[0]->reference_3_state ?? ''); ?>">
                                <?php echo e($references[0]->reference_3_state ?? ''); ?>
...
<?php endif; ?>
                    ...
                    <div class="col-md-6 mb-3 form-group d-none">
                        ...
                        <input id="reference_3_zipcode" name="reference_3_zipcode" type="text"
                            class="form-control" value="<?php echo e($references[0]->reference_3_zipcode ?? ''); ?>"
                            data-rule-zipcodeUS="true" data-msg-zipcodeUS="Invalid Zip Code" />
                    </div>
                    ...
                    <div class="col-md-6 mb-3 form-group">
                        ...
                        <input id="reference_3_email" name="reference_3_email" type="text" class="form-control unique_email"
                            value="<?php echo e($references[0]->reference_3_email ?? ''); ?>" data-rule-email="true" required />
                    </div>
                    ...
                    <div class="col-md-6 mb-3 form-group">
                        ...
                        <input id="reference_3_facility" name="reference_3_facility" type="text"
                            class="form-control" value="<?php echo e($references[0]->reference_3_facility ?? ''); ?>" />
                    </div>
                    ...
                    <div class="col-md-6 mb-3 form-group">
                        ...
                        <select class="form-select" id="reference_4_specialty" name="reference_4_specialty">
                            <?php if($references[0]->reference_4_specialty == ''): ?>
                                <option value="">Select Your Specialty</option>
                            <?php else: ?>
                                <option value="<?php echo e($references[0]->reference_4_specialty); ?>">
                                    <?php echo e($references[0]->reference_4_specialty); ?>
...
<?php endif; ?>
                    ...
                    <div class="col-md-6 mb-3 form-group">
                        ...
                        <input id="reference_4_position" name="reference_4_position" type="text"
                            class="form-control" value="<?php echo e($references[0]->reference_4_position ?? ''); ?>" />
                    </div>
                    ...
                    <div class="col-md-6 mb-3 form-group">
                        ...
                        <input id="reference_4_address" name="reference_4_address" type="text"
                            class="form-control" value="<?php echo e($references[0]->reference_4_address ?? ''); ?>" />
                    </div>
                    ...
                    <div class="col-md-6 mb-3 form-group">
                        ...
                        <select name="reference_4_state" class="form-select">
                            <option value="<?php echo e($references[0]->reference_4_state ?? ''); ?>">
                                <?php echo e($references[0]->reference_4_state ?? ''); ?>
...
<?php endif; ?>
                    ...
                    <div class="col-md-6 mb-3 form-group d-none">
                        ...
                        <input id="reference_4_zipcode" name="reference_4_zipcode" type="text"
                            class="form-control" value="<?php echo e($references[0]->reference_4_zipcode ?? ''); ?>"
                            data-rule-zipcodeUS="true" data-msg-zipcodeUS="Invalid Zip Code" />
                    </div>
                    ...
                    <div class="col-md-6 mb-3 form-group">
                        ...
                        <input id="reference_4_email" name="reference_4_email" type="text" class="form-control unique_email"
                            value="<?php echo e($references[0]->reference_4_email ?? ''); ?>" data-rule-email="true" required />
                    </div>
                    ...
                    <div class="col-md-6 mb-3 form-group">
                        ...
                        <input id="reference_4_facility" name="reference_4_facility" type="text"
                            class="form-control" value="<?php echo e($references[0]->reference_4_facility ?? ''); ?>" />
                    </div>
...
<?php endif; ?>
<?php /**PATH /var/www/html/resources/views/components/form-5.blade.php ENDPATH**/ ?>
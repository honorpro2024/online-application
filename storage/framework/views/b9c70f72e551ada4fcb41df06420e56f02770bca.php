...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.breadcrumb','data' => ['title' => 'View Application']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'View Application']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="middle_name" name="middle_name" type="text"
                                                    class="form-control" value="<?php echo e($personal_information->middle_name); ?>" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="home_address" name="home_address" type="text"
                                                    class="form-control" value="<?php echo e($personal_information->home_address); ?>"
                                                    required />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="state" name="state" type="text" class="form-control"
                                                    value="<?php echo e($personal_information->state); ?>" required />
                                            </div>

                                            <div class="col-md-6 mb-3 form-group">
                                                <label for="zip_code" class="form-label">Zip code</label>
                                                <input id="zip_code" name="zip_code" type="text"
                                                    class="form-control" value="<?php echo e($personal_information->zip_code); ?>" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="primary_speciality" name="primary_speciality" type="text"
                                                    class="form-control"
                                                    value="<?php echo e($personal_information->primary_speciality); ?>" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="secondary_speciality" name="secondary_speciality"
                                                    type="text" class="form-control"
                                                    value="<?php echo e($personal_information->secondary_speciality); ?>" />
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 form-group">
                                                ...
                                                <input id="medicaid" name="medicaid" type="text"
                                                    class="form-control" value="<?php echo e($personal_information->medicaid); ?>" />
                                            </div>
                                                ...
                                                <?php $__currentLoopData = $board_certifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $board_certificate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="row certificate_wrapper_item">
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input name="issuing_board_speciality[<?php echo e($key); ?>]"
                                                                type="text" class="form-control"
                                                ...
                                                <?php $__currentLoopData = $licensing; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $license): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="row licensing_wrapper_item">
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input name="license_expiration_date[<?php echo e($key); ?>]"
                                                                type="date" class="form-control"
                                                ...
                                                <?php $__currentLoopData = $dea_substances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $dea_substance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="row licensing_dea_wrapper_item">
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input name="license_dea_granted_date[<?php echo e($key); ?>]"
                                                                type="date" class="form-control"
                                                ...
                                                <?php $__currentLoopData = $credentialing_application_form; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $caf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="row explanation_wrapper_item">
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input name="explanation_question[<?php echo e($key); ?>]"
                                                                type="date" class="form-control"
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <textarea name="explanation_answer[<?php echo e($key); ?>]"
                                                                class="form-control"><?php echo e($caf->explanation_answer); ?></textarea>
                                                        </div>
                                                ...
                                                <?php $__currentLoopData = $malpractice_claims; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $malpractice_claim): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="row insurance_claim_wrapper_item">
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input name="location[<?php echo e($key); ?>]" type="text"
                                                                class="form-control"
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input name="status[<?php echo e($key); ?>]" type="text"
                                                                class="form-control"
                                                ...
                                                <?php $__currentLoopData = $current_medical_education; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cme): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="row current_medical_education_wrapper_item">
                                                        ...
                                                        <div class="col-md-6 mb-3 form-group">
                                                            ...
                                                            <input name="sponsoring_organization[<?php echo e($key); ?>]"
                                                                type="text" class="form-control"
    ...
    <script>
        function print() {
            printJS({
                ...
                targetStyles: ['*'],
                css: '<?php echo e(asset('assets/admin/css/bootstrap.min.css')); ?>',
                scanStyles: true,
            })
        }
    </script>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/users/show.blade.php ENDPATH**/ ?>
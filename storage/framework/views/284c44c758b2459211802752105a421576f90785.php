...
<?php $__env->startSection('content'); ?>
    ...
    <section class="py-6">
        <div class="container">
            <form action="<?php echo e(route('reset-password')); ?>" method="post" id="login_form">
                <?php echo csrf_field(); ?>
                <div class="mb-0 b-0">
                    <div class="row">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/auth/reset_password.blade.php ENDPATH**/ ?>
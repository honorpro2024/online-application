...
<?php foreach($attributes->onlyProps(['professional_liability_claim' => null]) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
<?php $attributes = $attributes->exceptProps(['professional_liability_claim' => null]); ?>
<?php foreach (array_filter((['professional_liability_claim' => null]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<?php if($professional_liability_claim == null || empty($professional_liability_claim)): ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3 form-group">
                        ...
                        <input name="reference_to_adverse_events" type="text" class="form-control"
                            value="<?php echo e($professional_liability_claim->reference_to_adverse_events); ?>" maxlength="255" />
                    </div>
...
<?php endif; ?>
<?php /**PATH /var/www/html/resources/views/components/form-12.blade.php ENDPATH**/ ?>